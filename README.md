...
- **JData:** Gerencia a integração de rede e o tratamento de dados.  
...
1. **Documentação do código:** Uma documentação detalhada dos códigos e lógicas reutilizáveis, principalmente nos _frameworks_ internos.